...
namespace KeToanCongNoPhaiThu.Controllers
{
    public class HoaDonsController : Controller
    {
        ...
        // Hàm tiện ích để set SelectList
        private void SetViewBags(object? selectedMaKH = null, string? selectedTrangThai = null)
        {
            ViewData["MaKH"] = new SelectList(_context.KhachHangs, "MaKH", "TenKH", selectedMaKH);
            ViewData["TrangThaiList"] = new SelectList(
                new[] { "Đã thanh toán", "Chưa thanh toán", "Thanh toán một phần" }, selectedTrangThai
            );
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var hoaDon = await _context.HoaDons.Include(h => h.KhachHang).FirstOrDefaultAsync(m => m.MaHD == id);
        ...
        public async Task<IActionResult> Create([Bind("NgayLap,TongTien,TrangThai,MaKH")] HoaDon hoaDon)
        {
            ...
            SetViewBags(hoaDon.MaKH, hoaDon.TrangThai);
            return View(hoaDon);
        }
